...
/* 一枚小胶囊代替原来的两段式开关（唐美芳 2026-09-09：「你能变成一个 icon，
   放在搜索框最右侧，搜索框可以变窄点，腾出点位置」）。
   ⚠️ 保留「零售 / 结算」两个字而不做成纯图标：这个开关一按就把结算价和毛利
   露出来，销售随时可能把屏幕转给客人看，当前处于哪一档必须一眼可读，
   纯图标做不到。宽度已从 94px 压到 ~52px，仍是 icon 量级。
...
function pmIcon(cls) {
  var sale = pmSales();
  return '<a class="pm-ic' + (sale ? ' on' : '') + (cls ? ' ' + cls : '') +
    '" data-pmic title="' +
    '当前' + (sale ? '为销售模式，页面显示结算价与毛利；把屏幕转给客人看之前请切回零售价'
                  : '为客人模式，只显示零售价') + '。点击切换">' +
    '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" ' +
    'stroke-linecap="round" stroke-linejoin="round">' +
    '<path d="M20.6 13.4 13.4 20.6a2 2 0 0 1-2.8 0l-7.2-7.2A2 2 0 0 1 2.8 12V4a1.2 1.2 0 0 1 1.2-1.2h8' +
    'a2 2 0 0 1 1.4.6l7.2 7.2a2 2 0 0 1 0 2.8Z"/>' +
